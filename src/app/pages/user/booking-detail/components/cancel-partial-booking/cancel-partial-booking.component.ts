...
@Component({
  ...
  templateUrl: './cancel-partial-booking.component.html',
  styleUrls: ['./cancel-partial-booking.component.scss']
})
export class CancelPartialBookingModalComponent implements OnInit {
