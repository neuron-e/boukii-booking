...
@Component({
  selector: 'vex-booking-detail-old',
...
export class BookingDetailComponent implements OnInit {
  ...
  getData(updateBooking = false) {
    ...
    .subscribe((school) => {
      ...
      this.settings = typeof school.data.settings === 'string' ? JSON.parse(school.data.settings) : school.data.settings;
  ...
  create() {
    ...
    // BOUKII CARE DESACTIVADO -             boukii_care: {name: 'Boukii Care', quantity: 1, price: parseFloat(this.booking.price_boukii_care)},
