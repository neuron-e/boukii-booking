...
import {MOCK_COUNTRIES} from './countries-data';
...
export class UtilsService {
  ...
  constructor(private crudService: ApiCrudService, private schoolService: SchoolService,
  ...
  getClientDegreeByClient(client: any, sport_id: number) {
    if (client && client !== null && sport_id && sport_id !== null) {
      const sportObject = client?.client_sports.find(
        (obj) => obj.sport_id === sport_id && obj.school_id == this.schoolData.id
      );
